...
Структура данных хранит элементы и количество их вхождений. Реализация параметризуется (через Функтор `Make`) модулем `Elt`, описывающим тип элемента и способ его разбиения на компоненты.
